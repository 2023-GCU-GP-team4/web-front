...
// level마다 변경
import pic_mouseleave from "../img/level3_mouseleave.png";
import pic_mouseover from "../img/level3_mouseover.png";
...
export default function Level3() {
    ...
    return (
        <div className="full-screen">
            <div className="title_level"> <b> LEVEL 3 </b> </div>
            <div className="contents">
                <div className="middle">
                    ...
                    <Link to={`/uploadFile/${id}`} className="outline" style={{ textDecoration: 'none' }} onClick={handleContentClick}>
                        <div className="pic">
